...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT) // 정해진 포트로 Tomcat 서버를 띄우고 테스트를 실행
public class HelloApiTest {
    ...
    void failsHelloApi() {
        ...
        assertThat(res.getStatusCode()).isEqualTo(HttpStatus.INTERNAL_SERVER_ERROR); // 500 ERROR
    }
}
